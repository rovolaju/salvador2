...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    //default
    'default': {
      formTpl:      '<form class="uk-form" class="editable-wrap"></form>',
      noformTpl:    '<span class="editable-wrap"></span>',
      controlsTpl:  '<span class="editable-controls"></span>',
      inputTpl:     '',
      errorTpl:     '<div class="editable-error" ng-show="$error" ng-bind="$error"></div>',
      buttonsTpl:   '<br><br><span class="editable-buttons"></span>',
      submitTpl:    '<button class="uk-button uk-button-primary" type="submit">Guardar</button>',
      cancelTpl:    '<button class="uk-button uk-button-primary" type="button" ng-click="$form.$cancel()">Cancelar</button>'
    },
